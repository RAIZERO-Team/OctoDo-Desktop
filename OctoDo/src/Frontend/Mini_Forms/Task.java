...
public class Task extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Task_Num = new javax.swing.JLabel();
        ...
        Task_Num.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Task_Num.setForeground(new java.awt.Color(0, 0, 0));
        Task_Num.setText("Task1");
        Task.add(Task_Num, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 25, 90, 20));
    ...
    private javax.swing.JLabel Task_Num;
