...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("Asstes/SVG_Icons/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("Asstes/SVG_Icons/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("Asstes/SVG_Icons/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("Asstes/SVG_Icons/light.svg"));
        }
    }
